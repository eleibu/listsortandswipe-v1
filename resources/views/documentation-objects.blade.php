...
<div class="section-cont">
    <a id="{{$refs_objects['instance']['aref']}}" class="title-section">
...
<div class="section-cont">
    <a id="{{$refs_objects['props']['aref']}}" class="title-section">
        {{$refs_objects['props']['title']}}
    </a>
    <p>
        An object containing options and events for the Lithium List instance. See <a href="{{ url($subpages['options']['url']) }}" title="{{$subpages['options']['detailsTitle']}}">{{$subpages['options']['detailsTitle']}}</a> and <a href="{{ url($subpages['events']['url']) }}" title="{{$subpages['events']['detailsTitle']}}">{{$subpages['events']['detailsTitle']}}</a> for available parameters.
    </p>
    <div class="title-codeblock">
        EXAMPLE JS
    </div>

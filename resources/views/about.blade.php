    ...
    <div class="section-outer">
        <div class="details">
            <div class="description">
                ...
                <p>
                    There are lots of Javascript plugins out there that enable sorting of items, but none that also enable swiping and auto-scrolling. At least none that I could find. So I decided to write one myself. And it was... tricky. Getting this to work reliably in any browser and on any device was quite a challenge, and I&#39;m very happy with the result. Lithium List was born.
                </p>
                <p>

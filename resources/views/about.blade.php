    ...
    <div class="section-outer">
        <div class="details">
            <div class="description">
                ...
                <p>
                    A while ago I made a little web-based task list app. The idea was pretty simple: a list of tasks that you swipe to delete or archive, and long-press to sort. Just like a list of items in an iOS or Android app.
                </p>
                <p>
                    There are lots of Javascript plugins out there that enable sorting of items, but none that also enable swiping and auto-scrolling. At least none that I could find. So I decided to write one myself. And it was... tricky. Getting it to work reliably in any browser and on any device was quite a challenge, but I&#39;m very happy with the result. Lithium List was born.
                </p>
                <p>

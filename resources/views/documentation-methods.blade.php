<div class="pagelinks">
    @foreach ($refs_methods as $ref)
        <a class="button-word-cont" href="{{ url($selectedpage['url'] . '#' . $ref['aref']) }}" title="{{$ref['title']}}">{{$ref['title']}}</a>
    @endforeach
</div>
<div class="section-cont">
    <a id="{{$refs_methods['attachToList']['aref']}}" class="title-section">
        {{$refs_methods['attachToList']['title']}}
    </a>
    <p>
        Attaches Lithium List to a list. See the <a href="{{$subpages['set-up']['url']}}" title="set up page">set up page</a> for a discussion of the required HTML and CSS. Each attachment creates its own <a href="{{ url($subpages['objects']['url'] . '#' . $refs_objects['instance']['aref']) }}" title="{{$refs_objects['instance']['title']}}">{{$refs_objects['instance']['title']}}</a>.
    </p>
    <div class="function">
...
<div class="section-cont">
    <a id="{{$refs_methods['detachFromList']['aref']}}" class="title-section">
...
<div class="section-cont">
    <a id="{{$refs_methods['setListProperties']['aref']}}" class="title-section">
...
<div class="section-cont">
    <a id="{{$refs_methods['setDefaultProperties']['aref']}}" class="title-section">
...
<div class="section-cont">
    <a id="{{$refs_methods['triggerLeft']['aref']}}" class="title-section">
...
<div class="section-cont">
    <a id="{{$refs_methods['triggerRight']['aref']}}" class="title-section">

...
export var lithiumlist = (function () {
	...
	var getIgnoreObjects = function(ignoreOnClick) {
		var ignoreObjects = [];
	...
	var extractClassNames = function(text, classNames) {
	...
	var createIgnoreObject = function(name, classNames) {
	...
	var shouldIgnoreOnClick = function(instance, target, listItem) {
		var returnVal = false;
	...
	var idIsOrContainsTarget = function(id, classNames, target, listItem) {
		var returnVal = false;
		if (target !== listItem) {
	...
	var tagIsOrContainsTarget = function(tagname, classNames, target, listItem) {
		var returnVal = false;
		if (target !== listItem) {
	...
	var classIsOrContainsTarget = function(classNames, target, listItem) {
		var returnVal = false;
		if (target !== listItem) {
	...
	var hasAllClassNames = function(target, classNames) {
		for (var i = 0, len = classNames.length; i < len; i++) {
